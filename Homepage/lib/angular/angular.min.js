...
(function (N, Y, q) {
            ...
            function J(a, b, c, d, e) {
                ...
                function h(a, b) {
                    ...
                    if (B(a)) {
                        ...
                        c = b[d]("$" + a + "Controller");
                        if (!c && !e)throw Error("No controllers: " + a);
                ...
                for (var l = -Number.MAX_VALUE, m = [], s = [], p = null, J = null, z = null, D = c.$$element = u(b), r, F, T, ka, S = d, y, x, X, v = 0, A = a.length; v < A; v++) {
                    ...
                    F = r.name;
                    if (X = r.controller)y = y || {}, ua("'" + F + "' controllers", y[F], r, D), y[F] = r;
    ...
    function wa(b, a) {
        var c = Hb.exec(b), c = {protocol: c[1], host: c[3], port: G(c[5]) || Ib[c[1]] || null, path: c[6] || "/", searchCommunity: c[8], hash: c[10]};
    ...
    function Gc(b, a, c) {
        ...
        if (decodeURIComponent(d.path) == a && !x(d.hash) && d.hash.indexOf(c) === 0)return b; else {
            var e = d.searchCommunity && "?" + d.searchCommunity || "", g = d.hash && "#" + d.hash || "", h = a.substr(0, a.lastIndexOf("/")), f = d.path.substr(h.length);
    ...
    function ib(b, a, c) {
        ...
        this.$$parse = function (b) {
            ...
            this.$$search = Wa(c.searchCommunity);
    ...
    function Ha(b, a, c) {
        ...
        this.$$parse = function (b) {
            ...
            d = c.path + (c.searchCommunity ? "?" + c.searchCommunity : "");
    ...
    function Ic() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            a ? (j = d.baseHref() || "/", i = j.substr(0, j.lastIndexOf("/")), m = la(m.protocol, m.host, m.port) + i + "/",
                f = e.history ? new ib(Fc(k, j, b), i, m) : new Jb(Gc(k, j, b), b, m, j.substr(i.length + 1))) : (m = la(m.protocol, m.host, m.port) + (m.path || "") + (m.searchCommunity ? "?" + m.searchCommunity : "") + "#" + b + "/", f = new Ha(k, b, m));
    ...
    function Qc() {
        ...
        this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", function (a, c, d, e, g, h, f) {
            ...
            function i() {
                var b = k(), i = t.current;
                if (b && i && b.$$route === i.$$route && ga(b.pathParams, i.pathParams) && !b.reloadOnSearch && !l)i.params = b.params, V(i.params, d), a.$broadcast("$routeUpdate", i); else if (b || i)l = !1, a.$broadcast("$routeChangeStart", b, i), (t.current = b) && b.redirectTo && (B(b.redirectTo) ? c.path(m(b.redirectTo, b.params)).searchCommunity(b.params).replace() : c.url(b.redirectTo(b.pathParams, c.path(), c.searchCommunity())).replace()), e.when(b).then(function () {
                    if (b) {
                        var a = [], c = [], d;
            ...
            function k() {
                var a, d;
                n(b, function (b, e) {
                    if (!d && (a = j(c.path(), e)))d = za(b, {params: v({}, c.searchCommunity(), a), pathParams: a}), d.$$route = b
                });
    ...
    function Sc() {
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", function (a, c, d) {
            ...
            e.prototype = {$new: function (a) {
                if (H(a))throw Error("API-CHANGE: Use $controllers to instantiate controllers.");
